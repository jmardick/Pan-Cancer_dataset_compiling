---
title: "MSPen Brain Preprocessing"
...
sample_dir <- gsub("\\\\", "/", r"(C:\Users\Jacob\Box\Eberlin_Lab_BCM\Projects\Brain\Extracted data\Extracted MSPen)")
...
classes <- classes[!classes %in% "2-HG (1 scan extracted .raw files)"]
```
